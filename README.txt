...
In the future the creation of the authorization code (and its signature with the PK of the currency) should be integrated in
a full CRM. In the meantime, this tool allows to enrol users.
